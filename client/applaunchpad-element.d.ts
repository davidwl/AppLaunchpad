// Type definitions for AppLaunchpad Client web components
...
export declare interface UxManager {
   ...
   * @example
   * import AppLaunchpadClient from '@kyma-project/applaunchpad-client';
   * const settings = {
   *  header: "Confirmation",
   ...
   * @since 1.4.0
   * @example AppLaunchpadClient.uxManager().setDocumentTitle('AppLaunchpad');
   */
   ...
   * @example AppLaunchpadClient.uxManager().getDocumentTitle();
   */
...
export declare interface LinkManager {
   ...
   * @example
   * AppLaunchpadClient.linkManager().updateTopNavigation();
   */
   ...
   * @see {@link https://docs.applaunchpad-project.io/docs/applaunchpad-client-api?section=splitview|SplitView Client} for further documentation. These methods from the Client SplitView are also implemented for AppLaunchpad Core: `close`, `collapse`, `expand`, `isCollapsed`, `isExpanded`, `exists`
   *
   * @since 0.7.6
   * @example
   * AppLaunchpadClient.linkManager().openAsSplitView('projects/pr1/users', {title:'Users', size:'40'});
   */
...
export declare class AppLaunchpadElement extends HTMLElement {
  constructor(options?: Options);
  /**
   * Override to return the html template string defining the web component view.
   *
   * @param {*} ctx The context object passed by applaunchpad core
   */
   ...
   *
   * @param {*} ctx The new context object passed by applaunchpad core
   */
  ...
  /**
   * AppLaunchpadClient instance
   */
  AppLaunchpadClient: AppLaunchpadClient;
...
/**
 * Html string processing according to applaunchpad functionality.
...
export interface AppLaunchpadClient {
  /**
   * @returns {Object} node parameters, where the object property name is the node parameter name without the prefix, and its value is the value of the node parameter. For example `{sort: 'asc', page: 3}`
   * @memberof AppLaunchpadClient
   */
