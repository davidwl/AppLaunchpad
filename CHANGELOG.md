...
* [#2452](https://github.com/davidwl/applaunchpad/pull/2452) Make User Setting dialog to use compact controls and add User Account avatar([@UlianaMunich](https://github.com/UlianaMunich))
...
- [#2094](https://github.com/davidwl/applaunchpad/pull/2094) Fix hardcode LogoTitle aria-label and alt text ([@rafalgamon](https://github.com/rafalgamon))
...
- [#1761](https://github.com/davidwl/applaunchpad/pull/1761) multi-level keepSelectedForChildren ([@hardl](https://github.com/hardl))
...
- [#1634](https://github.com/davidwl/applaunchpad/pull/1634) Implement intent based navigation ([@ndricimrr](https://github.com/ndricimrr))
...
- [#1284](https://github.com/davidwl/applaunchpad/pull/1284) Documentation for Internationalization i18n ([@maxmarkus](https://github.com/maxmarkus))
...
- [#1075](https://github.com/davidwl/applaunchpad/pull/1075) Virtual tree navigation ([@maxmarkus](https://github.com/maxmarkus))
...
- [#632](https://github.com/davidwl/applaunchpad/pull/632) Remove side navigation footer when no footer text and no semi-collapsible navigation ([@marynaKhromova](https://github.com/marynaKhromova))
...
- [#514](https://github.com/davidwl/applaunchpad/pull/514) display picture in topnav for idp flow ([@JohannesDoberer](https://github.com/JohannesDoberer))
...
- [#417](https://github.com/davidwl/applaunchpad/pull/417) Fix node refresh ([@hardl](https://github.com/hardl))
...
- [#222](https://github.com/davidwl/applaunchpad/pull/222) Login fix ([@hardl](https://github.com/hardl))
- [#202](https://github.com/davidwl/applaunchpad/pull/202) Fix go-back-button bug ([@parostatkiem](https://github.com/parostatkiem))
- [#215](https://github.com/davidwl/applaunchpad/pull/215) mock auth logout page fix ([@y-kkamil](https://github.com/y-kkamil))
- [#211](https://github.com/davidwl/applaunchpad/pull/211) Multiple path parameters do not get replaced in view url ([@pekura](https://github.com/pekura))
- [#212](https://github.com/davidwl/applaunchpad/pull/212) Fix failing unit tests ([@dariadomagala](https://github.com/dariadomagala))
- [#206](https://github.com/davidwl/applaunchpad/pull/206) Center the logo ([@dariadomagala](https://github.com/dariadomagala))
- [#196](https://github.com/davidwl/applaunchpad/pull/196) Fix for goBack when not using micro frontend without routing ([@maxmarkus](https://github.com/maxmarkus))
- [#177](https://github.com/davidwl/applaunchpad/pull/177) Allow multiple init and update listeners ([@maxmarkus](https://github.com/maxmarkus))

#### :memo: Documentation

- [#197](https://github.com/davidwl/applaunchpad/pull/197) Improve applaunchpad-client js docs ([@kwiatekus](https://github.com/kwiatekus))
- [#155](https://github.com/davidwl/applaunchpad/pull/155) Describe get path params and get node params better ([@pekura](https://github.com/pekura))
- [#199](https://github.com/davidwl/applaunchpad/pull/199) Add missing line and improve wording ([@bszwarc](https://github.com/bszwarc))

## [v0.3.7] - 2018-10-31

#### :rocket: Added

- [#169](https://github.com/davidwl/applaunchpad/pull/169) Enable AppLaunchpad Client (micro frontend) to check whether a path exists in the main app ([@jesusreal](https://github.com/jesusreal))

#### :bug: Fixed

- [#168](https://github.com/davidwl/applaunchpad/pull/168) Fix bug for closest parent navigation on AppLaunchpad Client ([@jesusreal](https://github.com/jesusreal))

#### :memo: Documentation

- [#138](https://github.com/davidwl/applaunchpad/pull/138) Add details about navigation nodes and reading node parameters ([@bszwarc](https://github.com/bszwarc))
- [#176](https://github.com/davidwl/applaunchpad/pull/176) Update and improve the content of the installation guide ([@bszwarc](https://github.com/bszwarc))
- [#161](https://github.com/davidwl/applaunchpad/pull/161) Fix small docu bugs ([@jesusreal](https://github.com/jesusreal))

## [v0.3.6] - 2018-10-23

#### :rocket: Added

- [#131](https://github.com/davidwl/applaunchpad/pull/131) Make automatic login configurable ([@dariadomagala](https://github.com/dariadomagala))
- [#121](https://github.com/davidwl/applaunchpad/pull/121) Navigation node as a link to an external page ([@parostatkiem](https://github.com/parostatkiem))
- [#118](https://github.com/davidwl/applaunchpad/pull/118) Keep left-side navigation on a node hierarchy level ([@maxmarkus](https://github.com/maxmarkus))
- [#129](https://github.com/davidwl/applaunchpad/pull/129) Add automatic loading indicator to show processing ([@maxmarkus](https://github.com/maxmarkus))
- [#105](https://github.com/davidwl/applaunchpad/pull/105) Enable e2e tests ([@dariadomagala](https://github.com/dariadomagala))
- [#142](https://github.com/davidwl/applaunchpad/pull/142) View preservation is now allowed also cross-domain ([@maxmarkus](https://github.com/maxmarkus))

#### :bug: Fixed

- [#140](https://github.com/davidwl/applaunchpad/pull/140) Fix css issues in core and angular example ([@jesusreal](https://github.com/jesusreal))
- [#116](https://github.com/davidwl/applaunchpad/pull/116) Change per-component backdrop to global one ([@parostatkiem](https://github.com/parostatkiem))
- [#120](https://github.com/davidwl/applaunchpad/pull/120) Fix fonts bundling in applaunchpad core ([@parostatkiem](https://github.com/parostatkiem))
- [#115](https://github.com/davidwl/applaunchpad/pull/115) Re-login not redirecting to applaunchpad app ([@jesusreal](https://github.com/jesusreal))

#### :memo: Documentation

- [#148](https://github.com/davidwl/applaunchpad/pull/148) Copy template for security issues ([@franpog859](https://github.com/franpog859))
- [#135](https://github.com/davidwl/applaunchpad/pull/135) Improve getting started documentation ([@maxmarkus](https://github.com/maxmarkus))
- [#137](https://github.com/davidwl/applaunchpad/pull/137) Add autogenerated applaunchpad client api docs ([@jesusreal](https://github.com/jesusreal))

## [v0.3.5] - 2018-09-26

#### :rocket: Added

- [#104](https://github.com/davidwl/applaunchpad/pull/104) Dynamic pathSegments in navigation nodes ([@maxmarkus](https://github.com/maxmarkus))

#### :bug: Fixed

- [#84](https://github.com/davidwl/applaunchpad/pull/84) Remove unnecessary files from public folder ([@dariadomagala](https://github.com/dariadomagala))
- [#103](https://github.com/davidwl/applaunchpad/pull/103) Fix behavior of the logout dropdown ([@dariadomagala](https://github.com/dariadomagala))
- [#102](https://github.com/davidwl/applaunchpad/pull/102) Fix 'preserve view' feature for sibiling nodes ([@maxmarkus](https://github.com/maxmarkus))
- [#89](https://github.com/davidwl/applaunchpad/pull/89) Fix unnecessary 'authSuccessfull' handler execution on each page refresh ([@dariadomagala](https://github.com/dariadomagala))
- [#79](https://github.com/davidwl/applaunchpad/pull/79) Fix fundamental-ui issues in applications setup docu ([@jesusreal](https://github.com/jesusreal))

#### :memo: Documentation

- [#107](https://github.com/davidwl/applaunchpad/pull/107) Commands path info in angular example readme ([@parostatkiem](https://github.com/parostatkiem))

## [core-0.3.3] - 2018-09-14

#### :rocket: Added

- [#67](https://github.com/davidwl/applaunchpad/pull/67) Navigation node visibility with custom nodeAccessibilityResolver ([@maxmarkus](https://github.com/maxmarkus))

#### :bug: Fixed

- [#82](https://github.com/davidwl/applaunchpad/pull/82) Fixed changedetector bug ([@dariadomagala](https://github.com/dariadomagala))
- [#71](https://github.com/davidwl/applaunchpad/pull/71) Fixed top navigation popover behavior ([@maxmarkus](https://github.com/maxmarkus))
- [#76](https://github.com/davidwl/applaunchpad/pull/76) Fixed broken routing after successful OIDC authentication ([@maxmarkus](https://github.com/maxmarkus))
- [#57](https://github.com/davidwl/applaunchpad/pull/57) Fixed preserve view and back example ([@dariadomagala](https://github.com/dariadomagala))
- [#75](https://github.com/davidwl/applaunchpad/pull/75) Fixed import of AppLaunchpadClient on angular app ([@jesusreal](https://github.com/jesusreal))

#### :memo: Documentation

- [#80](https://github.com/davidwl/applaunchpad/pull/80) AppLaunchpad documentation refinements ([@dpolitesap](https://github.com/dpolitesap))
- [#34](https://github.com/davidwl/applaunchpad/pull/34) Introduce changelog file ([@jesusreal](https://github.com/jesusreal))

## [client-0.3.2] - 2018-09-10

#### :rocket: Added

- [#33](https://github.com/davidwl/applaunchpad/pull/33) Ensure es5 compliance for applaunchpad client ([@y-kkamil](https://github.com/y-kkamil))

## [core-0.3.1] - 2018-09-07

#### :bug: Fixed

- [#31](https://github.com/davidwl/applaunchpad/pull/31) Redirect from root node to first child ([@y-kkamil](https://github.com/y-kkamil))
- [#50](https://github.com/davidwl/applaunchpad/pull/50) #49 [fix] OAuth2 implicit grant flow should use GET as default reques… ([@aartek](https://github.com/aartek))
...
- Backdrop functionality can now be disabled via AppLaunchpad Config object.
- Add error message for missing AppLaunchpad Config.
...
- 'isHashRoute' flag to activate hash routing is moved to AppLaunchpad Config object under 'settings' and is called now 'useHashRouting'.
- AppLaunchpad Config is now under "window.AppLaunchpad.config" instead of "window.AppLaunchpadConfig" and "setConfig" and "getConfig" helper methods are available.
...
- Core: Navigation on top and left (can be disabled via AppLaunchpad Config object).
...
[core-0.3.0]: https://github.com/davidwl/applaunchpad/compare/v0.2.1...core-0.3.0
[core-0.3.1]: https://github.com/davidwl/applaunchpad/compare/core-0.3.0...core-0.3.1
[core-0.3.3]: https://github.com/davidwl/applaunchpad/compare/core-0.3.2...core-0.3.3
[client-0.3.2]: https://github.com/davidwl/applaunchpad/compare/client-0.3.1...client-0.3.2
[client-0.3.0]: https://github.com/davidwl/applaunchpad/compare/v0.2.1...client-0.3.0
[v0.3.5]: https://github.com/davidwl/applaunchpad/compare/core-0.3.3...v0.3.5
[v0.3.6]: https://github.com/davidwl/applaunchpad/compare/v0.3.5...v0.3.6
[v0.3.7]: https://github.com/davidwl/applaunchpad/compare/v0.3.6...v0.3.7
[v0.3.8]: https://github.com/davidwl/applaunchpad/compare/v0.3.7...v0.3.8
[v0.4.0]: https://github.com/davidwl/applaunchpad/compare/v0.3.8...v0.4.0
[v0.4.1]: https://github.com/davidwl/applaunchpad/compare/v0.4.0...v0.4.1
[v0.4.3]: https://github.com/davidwl/applaunchpad/compare/v0.4.2...v0.4.3
[v0.4.4]: https://github.com/davidwl/applaunchpad/compare/v0.4.3...v0.4.4
[v0.4.5]: https://github.com/davidwl/applaunchpad/compare/v0.4.4...v0.4.5
[v0.4.9]: https://github.com/davidwl/applaunchpad/compare/v0.4.8...v0.4.9
[v0.4.10]: https://github.com/davidwl/applaunchpad/compare/v0.4.9...v0.4.10
[v0.4.11]: https://github.com/davidwl/applaunchpad/compare/v0.4.10...v0.4.11
[v0.4.12]: https://github.com/davidwl/applaunchpad/compare/v0.4.11...v0.4.12
[v0.5.0]: https://github.com/davidwl/applaunchpad/compare/v0.4.12...v0.5.0
[v0.5.1]: https://github.com/davidwl/applaunchpad/compare/v0.5.0...v0.5.1
[v0.5.2]: https://github.com/davidwl/applaunchpad/compare/v0.5.1...v0.5.2
[v0.5.3]: https://github.com/davidwl/applaunchpad/compare/v0.5.2...v0.5.3
[v0.5.4]: https://github.com/davidwl/applaunchpad/compare/v0.5.3...v0.5.4
[v0.6.0]: https://github.com/davidwl/applaunchpad/compare/v0.5.4...v0.6.0
[v0.6.1]: https://github.com/davidwl/applaunchpad/compare/v0.6.0...v0.6.1
[v0.6.2]: https://github.com/davidwl/applaunchpad/compare/v0.6.1...v0.6.2
[v0.6.3]: https://github.com/davidwl/applaunchpad/compare/v0.6.2...v0.6.3
[v0.6.4]: https://github.com/davidwl/applaunchpad/compare/v0.6.3...v0.6.4
[v0.6.5]: https://github.com/davidwl/applaunchpad/compare/v0.6.4...v0.6.5
[v0.6.6]: https://github.com/davidwl/applaunchpad/compare/v0.6.5...v0.6.6
[v0.7.0]: https://github.com/davidwl/applaunchpad/compare/v0.6.6...v0.7.0
[v0.7.1]: https://github.com/davidwl/applaunchpad/compare/v0.7.0...v0.7.1
[v0.7.2]: https://github.com/davidwl/applaunchpad/compare/v0.7.1...v0.7.2
[v0.7.3]: https://github.com/davidwl/applaunchpad/compare/v0.7.2...v0.7.3
[v0.7.4]: https://github.com/davidwl/applaunchpad/compare/v0.7.3...v0.7.4
[v0.7.5]: https://github.com/davidwl/applaunchpad/compare/v0.7.4...v0.7.5
[v0.7.6]: https://github.com/davidwl/applaunchpad/compare/v0.7.5...v0.7.6
[v0.7.7]: https://github.com/davidwl/applaunchpad/compare/v0.7.6...v0.7.7
[v1.0.0]: https://github.com/davidwl/applaunchpad/compare/v0.7.7...v1.0.0
[v1.0.1]: https://github.com/davidwl/applaunchpad/compare/v1.0.0...v1.0.1
[v1.1.0]: https://github.com/davidwl/applaunchpad/compare/v1.0.1...v1.1.0
[v1.1.1]: https://github.com/davidwl/applaunchpad/compare/v1.1.0...v1.1.1
[v1.2.1]: https://github.com/davidwl/applaunchpad/compare/v1.1.1...v1.2.1
[v1.2.2]: https://github.com/davidwl/applaunchpad/compare/v1.2.1...v1.2.2
[v1.2.3]: https://github.com/davidwl/applaunchpad/compare/v1.2.2...v1.2.3
[v1.2.4]: https://github.com/davidwl/applaunchpad/compare/v1.2.3...v1.2.4
[v1.3.0]: https://github.com/davidwl/applaunchpad/compare/v1.2.4...v1.3.0
[v1.3.1]: https://github.com/davidwl/applaunchpad/compare/v1.3.0...v1.3.1
[v1.4.0]: https://github.com/davidwl/applaunchpad/compare/v1.3.1...v1.4.0
[v1.5.0]: https://github.com/davidwl/applaunchpad/compare/v1.4.0...v1.5.0
[v1.6.0]: https://github.com/davidwl/applaunchpad/compare/v1.5.0...v1.6.0
[v1.7.0]: https://github.com/davidwl/applaunchpad/compare/v1.6.0...v1.7.0
[v1.7.1]: https://github.com/davidwl/applaunchpad/compare/v1.7.0...v1.7.1
[v1.8.0]: https://github.com/davidwl/applaunchpad/compare/v1.7.1...v1.8.0
[v1.8.1]: https://github.com/davidwl/applaunchpad/compare/v1.8.0...v1.8.1
[v1.9.0]: https://github.com/davidwl/applaunchpad/compare/v1.8.1...v1.9.0
[v1.10.0]: https://github.com/davidwl/applaunchpad/compare/v1.9.0...v1.10.0
[v1.11.0]: https://github.com/davidwl/applaunchpad/compare/v1.10.0...v1.11.0
[v1.12.0]: https://github.com/davidwl/applaunchpad/compare/v1.11.0...v1.12.0
[v1.12.1]: https://github.com/davidwl/applaunchpad/compare/v1.12.0...v1.12.1
[v1.13.0]: https://github.com/davidwl/applaunchpad/compare/v1.12.1...v1.13.0
[v1.14.0]: https://github.com/davidwl/applaunchpad/compare/v1.13.0...v1.14.0
[v1.14.1]: https://github.com/davidwl/applaunchpad/compare/v1.14.0...v1.14.1
[v1.14.2]: https://github.com/davidwl/applaunchpad/compare/v1.14.1...v1.14.2
[v1.14.3]: https://github.com/davidwl/applaunchpad/compare/v1.14.2...v1.14.3
[v1.15.0]: https://github.com/davidwl/applaunchpad/compare/v1.14.3...v1.15.0
[v1.16.0]: https://github.com/davidwl/applaunchpad/compare/v1.15.0...v1.16.0
[v1.16.1]: https://github.com/davidwl/applaunchpad/compare/v1.16.0...v1.16.1
[v1.16.2]: https://github.com/davidwl/applaunchpad/compare/v1.16.1...v1.16.2
[v1.17.0]: https://github.com/davidwl/applaunchpad/compare/v1.16.2...v1.17.0
[v1.18.0]: https://github.com/davidwl/applaunchpad/compare/v1.17.0...v1.18.0
[v1.18.1]: https://github.com/davidwl/applaunchpad/compare/v1.18.0...v1.18.1
[v1.19.0]: https://github.com/davidwl/applaunchpad/compare/v1.18.1...v1.19.0
[v1.20.0]: https://github.com/davidwl/applaunchpad/compare/v1.19.0...v1.20.0
[v1.20.1]: https://github.com/davidwl/applaunchpad/compare/v1.20.0...v1.20.1
[v1.21.0]: https://github.com/davidwl/applaunchpad/compare/v1.20.1...v1.21.0
[v1.22.0]: https://github.com/davidwl/applaunchpad/compare/v1.21.0...v1.22.0
[v1.23.0]: https://github.com/davidwl/applaunchpad/compare/v1.22.0...v1.23.0
[v1.23.1]: https://github.com/davidwl/applaunchpad/compare/v1.23.0...v1.23.1
[v1.24.0]: https://github.com/davidwl/applaunchpad/compare/v1.23.1...v1.24.0
[v1.25.0]: https://github.com/davidwl/applaunchpad/compare/v1.24.0...v1.25.0
[v1.25.1]: https://github.com/davidwl/applaunchpad/compare/v1.25.0...v1.25.1
[v1.26.0]: https://github.com/davidwl/applaunchpad/compare/v1.25.1...v1.26.0
