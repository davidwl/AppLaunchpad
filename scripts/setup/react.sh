#!/usr/bin/env bash
echo ""
echo "Installing AppLaunchpad with React specification"
echo ""
if [[ "$1" = "" ]]; then
  read -p "AppLaunchpad project folder name (lowercase letters only): " folder
else
  folder=$1
  echo "AppLaunchpad project folder name (lowercase letters only): $folder"
fi
...
curl https://raw.githubusercontent.com/davidwl/applaunchpad/master/core/examples/applaunchpad-example-react/public/logo.png > public/logo.png
...
curl https://raw.githubusercontent.com/davidwl/applaunchpad/master/core/examples/applaunchpad-example-react/public/applaunchpad-config-file.js > src/applaunchpad-config/applaunchpad-config.es6.js


# add index.js
curl https://raw.githubusercontent.com/davidwl/applaunchpad/master/core/examples/applaunchpad-example-react/src/index-file.js > src/index.js
