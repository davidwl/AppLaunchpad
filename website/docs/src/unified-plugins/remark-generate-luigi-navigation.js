...
const staticAppLaunchpadFolder = 'static/applaunchpad/';
const navigationFile = staticAppLaunchpadFolder + 'navigation-generated.json';
const staticNavigation = readFileSync(staticAppLaunchpadFolder + 'navigation-nodes.json');

// initially write static navigation items to file
writeFileSync(navigationFile, String(staticNavigation));

export default function applaunchpadNavigationBuilder(data = {}) {
