import { version } from '../../../node_modules/@applaunchpad-project/client/package.json';
...
class Settings {
  ...
  sideNavFooterText = `AppLaunchpad Client: ${version || 'unknown'}`;
  ...
  //       return '*' + key + '* ' + (locale || AppLaunchpad.i18n().getCurrentLocale());
  //     }
  //   };
  // };
