...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        plugins: [
            // copy applaunchpad core resources to runtime directory
            new CopyWebpackPlugin({
                patterns: [
                    ...
                    {
                        context: 'public',
                        to: 'applaunchpad-config.js',
                        from: 'applaunchpad-config.js'
                    },
                    {
        ...
        optimization: {
            minimize: true,
            // todo: Remove after renaming applaunchpad core map files
            minimizer: [
                new TerserPlugin({
