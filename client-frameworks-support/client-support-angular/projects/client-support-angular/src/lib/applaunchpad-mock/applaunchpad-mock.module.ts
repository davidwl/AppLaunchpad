...
import { AppLaunchpadMockEngine } from '@applaunchpad-project/testing-utilities';
  ...
  providers: [
    {
      ...
      useFactory: AppLaunchpadMockEngine.initPostMessageHook,
      multi: true
    }
  ]
})
 ...
 */
export class AppLaunchpadMockModule {
